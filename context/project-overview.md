...
- Dashboard (main view): [dashboard-ui-main.png](screenshots/dashboard-ui-main.png)
- Dashboard with item detail drawer: [dashboard-ui-drawer.png](screenshots/dashboard-ui-drawer.png)
